...
export function convertirCelsiusAFahrenheit(temperatura_en_celsius) {
...
export default function TemperatureOptions() {
    const {setIsFahrenheit} = useContext(IsFahrenheitContext);
    ...
    return (
        <div className="w-full h-[10%] md:h-[20%] py-3 md:py-0 md:pr-1 flex items-end justify-center md:justify-end gap-4">
            <div className="w-10 h-10 md:w-11 md:h-11">
                <button
                className="w-full h-full bg-slate-200 font-medium p-2 md:p-1 rounded-full"
            ...
            <div className="w-10 h-10 md:w-11 md:h-11">
                <button
                    className="w-full h-full bg-slate-400 font-medium p-2 md:p-1 rounded-full"
